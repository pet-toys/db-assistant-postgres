...
internal sealed class NetworkAddressEntity
{
    ...
    [DbColumn("nullable_ip_address_has_value", NpgsqlDbType.Inet, true)]
    public IPAddress? NullableIpAddressHasValue { get; init; } = IPAddress.Parse("127.0.0.1");
    ...
    [DbColumn("nullable_mac_addr_has_value", NpgsqlDbType.MacAddr, true)]
    public PhysicalAddress? NullableMacAddressHasValue { get; init; } = PhysicalAddress.Parse("00:00:00:00:00:00");
}